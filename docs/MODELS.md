...
- `resnet18-cifar`: the same small-image ResNet-18 with a configurable head.
  The 200-class Tiny-ImageNet instance accepts 64x64 inputs and has 11,271,432
  parameters. ResNet-50 remains implemented for auxiliary scaling studies but
  is not used by the locked Tiny-ImageNet experiments.
